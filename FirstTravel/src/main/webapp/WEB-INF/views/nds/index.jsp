...
<div id="header">
  <div class="container"> 
    <!-- Header | Logo, Menu
		================================================== -->
    <div class="logo"><a href="index.html"><img src="/resources/nds/images/logo.png" alt="" /></a></div>
    <div class="mainmenu">
      <div id="mainmenu">
        <ul class="sf-menu">
...
<section class="slider">
  <div class="flexslider">
    <ul class="slides">
      <li> <a href="#"><img src="/resources/nds/images/flexslider/1.jpg" alt=""/></a>
      ...
      <li> <img src="/resources/nds/images/flexslider/2.jpg" alt="" />
        <section class="caption">
          <h2 class="shadow3">I am Freebix!</h2>
          <p>Free, fully responsive HTML site template made by <a href="http://www.anarieldesign.com/" rel="nofollow"><strong>Anariel Design</strong></a></p>
          <a class="button" href="#">Download me!</a></section>
      </li>
      <li> <a href="#"><img src="/resources/nds/images/flexslider/3.jpg" alt="" /></a>
        <section class="caption">
          <h2 class="shadow3">I am Freebix!</h2>
          <p>Free, fully responsive HTML site template made by <a href="http://www.anarieldesign.com/" rel="nofollow"><strong>Anariel Design</strong></a></p>
          <a class="button" href="#">Download me!</a></section>
