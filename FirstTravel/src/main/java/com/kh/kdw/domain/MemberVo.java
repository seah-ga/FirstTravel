...
public class MemberVo {
	...
	public String toString() {
		return "MemberVo [user_code=" + user_code + ", user_id=" + user_id + ", user_name=" + user_name + ", user_pw="
				+ user_pw + ", address_num=" + address_num + ", address=" + address + ", detail_address="
				+ detail_address + ", user_phone=" + user_phone + ", user_email=" + user_email + ", chk_ad=" + chk_ad
				+ ", user_point=" + user_point + ", joindate=" + joindate + "]";
	}
