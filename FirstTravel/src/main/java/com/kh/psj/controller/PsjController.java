...
//	}
	...
	public void plan(Model model,HttpSession session) {
	...
	public void schedule(@RequestParam("enterDate")String enterDate, Model model, HttpSession session) {
		...
		try {
				...
				System.out.println("schtVo" + schtitleVo);
	...
	//					System.out.println("if문 실행ㄴ");
				...
				System.out.println("schtitle" + schTitleJSONList);
